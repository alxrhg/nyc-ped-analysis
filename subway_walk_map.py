"""
NYC Subway Station 10-Minute Walk Radius Map

Generates an interactive map showing the area reachable within a 10-minute walk
(~800 meters) from every NYC subway station. Inspired by similar transit
...
# 10-minute walk ≈ 800 meters at standard pedestrian speed (~4.8 km/h)
...
def create_subway_walk_map():
    """Create an interactive Folium map with 10-min walk radius circles."""
    ...
    for name, lat, lon, routes in STATIONS:
        ...
        Circle(
            ...
            popup=Popup(
                ...
                f"10-min walk ({WALK_RADIUS_METERS}m radius)",
                max_width=250,
            ),
        ).add_to(m)
    ...
    <div style="
        ...
        max-width: 200px;
    ">
        <b style="font-size:14px;">NYC Subway<br>10-Min Walk Radius</b>
    ...
    <div style="
        ...
        font-weight: bold;
    ">
        NYC Subway Stations &mdash; 10-Minute Walk Coverage
    </div>
    """
...
if __name__ == "__main__":
    ...
    print(f"Walk radius: {WALK_RADIUS_METERS}m (~10 minutes)")
    m = create_subway_walk_map()
    output_file = "subway_walk_map.html"
    m.save(output_file)
